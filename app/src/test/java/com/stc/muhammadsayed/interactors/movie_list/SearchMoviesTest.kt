...
import com.stc.muhammadsayed.cache.MovieDaoFake
import com.stc.muhammadsayed.cache.model.MovieEntityMapper
import com.stc.muhammadsayed.data.MockWebServerResponse.movieListResponse
...
class SearchMoviesTest {
    ...
    fun getMoviesFromNetwork_emitMoviesFromCache(): Unit = runBlocking {
        ...
        val flowItem = searchMovies.execute(
            DUMMY_TOKEN, 1,
            DUMMY_QUERY, true
        ).toList()
